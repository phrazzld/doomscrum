...
pub async fn render_spec(
    ...
    // Any render with a real cost gets written (fal video, stills keyframe);
    // free fixture renders with a zero estimate are skipped.
    if render.cost_estimate_usd > 0.0 {
